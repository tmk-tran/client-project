                ...
                <>
                    {fundraiser.closed != true &&
                        <TableRow className="active_row" style={{ border: "2px solid black" }}>
                            ...
                            <TableCell className="active_table_cell" ><Typography style={{ fontSize: "15px", textAlign: "center" }}><OutlinedInput style={{ fontSize: "15px", width: "100px", height: "30px" }} value={booksCheckedOut} onChange={(e) => setBooksCheckedOut(e.target.value)}>{fundraiser.book_quantity_checked_out}</OutlinedInput></Typography></TableCell>

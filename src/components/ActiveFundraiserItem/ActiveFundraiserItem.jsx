                ...
                <>
                    {fundraiser.closed != true &&
                        <TableRow className="active_row" style={{ border: "2px solid black" }}>
                            <TableCell className="active_table_cell" ><Typography style={{ fontSize: "15px", width: "88px", textAlign: "center" }}>{fundraiser.title}</Typography></TableCell>
                            ...
                            <TableCell className="active_table_cell" ><Typography style={{ fontSize: "15px", textAlign: "center" }}><OutlinedInput style={{ fontSize: "15px", width: "100px", height: "40px" }} value={booksCheckedOut} onChange={(e) => setBooksCheckedOut(e.target.value)}>{fundraiser.book_quantity_checked_out}</OutlinedInput></Typography></TableCell>
                            ...
                            <TableCell className="active_table_cell" ><Typography style={{ fontSize: "15px", textAlign: "center" }}><OutlinedInput style={{ fontSize: "15px", width: "100px", height: "40px" }} value={booksCheckedIn} onChange={(e) => setBooksCheckedIn(e.target.value)}>{fundraiser.book_quantity_checked_in}</OutlinedInput></Typography></TableCell>
                            <TableCell className="active_table_cell" > <Typography style={{ fontSize: "15px", textAlign: "center"}}><OutlinedInput style={{ fontSize: "15px", width: "100px", height: "40px" }} value={booksSold} onChange={(e) => setBooksSold(e.target.value)}>{fundraiser.books_sold}</OutlinedInput></Typography></TableCell>
                            <TableCell className="active_table_cell" ><Typography style={{ fontSize: "15px", textAlign: "center" }}><OutlinedInput style={{ fontSize: "15px", width: "100px", height: "40px" }} value={moneyReceived} onChange={(e) => setMoneyRecieved(e.target.value)}>{fundraiser.money_received}</OutlinedInput></Typography></TableCell>
                            ...
                            <TableCell className="active_table_cell" style={{textAlign: "center", minWidth: "250px"}} >
